...
const CartRemoveClosedbin = ({ handleMouseOver }) => {
  return (
    <div>
      <svg
      ...
      >
        ...
        <g id="SVGRepo_iconCarrier">
          ...
          <g>
            {" "}
            <path d="M45.5,10H32.9V6c0-2.2-1.8-4-4-4h-6c-2.2,0-4,1.8-4,4v4H6.4c-0.8,0-1.5,0.7-1.5,1.5v3 c0,0.8,0.7,1.5,1.5,1.5h39c0.8,0,1.5-0.7,1.5-1.5v-3C46.9,10.7,46.3,10,45.5,10z M28.8,10h-5.9V7c0-0.6,0.4-1,1-1h4 c0.6,0,1,0.4,1,1V10z"></path>{" "}
...
export default CartRemoveClosedbin;
